  ...
  <div>
      ...
      <el-collapse-item title="任务拆分情况"
        ...
        <el-card v-for="(item,index) in tasks"
          ...
          <el-button type="primary"
                     plain
                     @click="submitSubtask( item)">审核</el-button>
        </el-card>
      </el-collapse-item>
    ...
    <div class="btn-group"
      ...
      <el-button type="primary"
                 v-show="stage=='4'"
                 plain
                 @click="submitMainTask( )">核定</el-button>
      <el-button type="primary"
                 v-show="stage=='5'"
                 plain
      ...
      <el-button type="primary"
                 plain
                 @click="diagramVisible=true">流程圖</el-button>
    </div>
  ...
  computed: {
    flowableTaskId () {
      if (this.flowableMainTask)
        return this.flowableMainTask.id;
      else
        return ""
    },
    flowableProcessId () {
      if (this.flowableMainTask)
        return this.flowableMainTask.processInstanceId;
      else
        return ""
    },
  },
